...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent(){
        ...
        labelrollno = new JLabel("170421"+first4);
        ...
        tfaadhar.setFont(new Font("Tahoma", Font.PLAIN,18));
        add(tfaadhar);
        ...
        String course[]= {"B.Tech", "BBA", "BCA", "B.Sc", "B.Com", "BA", "M.Tech", "MBA", "MCA", "M.Sc", "M.Com", "MA"};
